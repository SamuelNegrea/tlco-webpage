...
@Component({
  selector: 'app-servereinfrastrutture',
  templateUrl: './servereinfrastrutture.component.html',
  styleUrls: ['./servereinfrastrutture.component.scss']
})
export class ServereinfrastruttureComponent implements OnInit {
  options: any;
  selectedOption: any;
  constructor() {
    this.options = [
