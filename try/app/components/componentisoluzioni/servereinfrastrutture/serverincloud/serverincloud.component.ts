...
@Component({
  selector: 'app-serverincloud',
  templateUrl: './serverincloud.component.html',
  styleUrls: ['./serverincloud.component.scss']
})
export class ServerincloudComponent implements OnInit {
  options: any;
  selectedOption: any;
  constructor() { 
    this.options = [
